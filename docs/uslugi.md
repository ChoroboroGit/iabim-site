...
<div class="service-section">
  <div class="service-content">
    ...
    <h3>Standard i jakosc</h3>
    <ul>
      <li>LOD/LOI zgodne z wytycznymi kontraktu.</li>
      <li>Jednolite nazewnictwo, parametry i prefiksy.</li>
      <li>Kontrola widocznosci i szablonow widokow.</li>
    </ul>
    <h3>Formaty dostaw</h3>
    <ul>
      <li>RVT, IFC, DWG, DXF, XLS, DOCX, PDF/A.</li>
    </ul>
  </div>
...
<div class="service-section reverse">
  <div class="service-content">
    ...
    <ul>
      ...
      <li>Eksport list kolizji do PDF/XLSX.</li>
    </ul>
  </div>
  <div class="service-image">
...
<div class="service-section">
  <div class="service-content">
    ...
    <ul>
      ...
      <li>Stabilne logi po polsku, raport zmian.</li>
    </ul>
  </div>
  <div class="service-image">
...
<div class="service-section reverse">
  <div class="service-content">
    <h2>Raporty i przeplywy danych</h2>
    ...
    <h3>Standard</h3>
    <ul>
      <li>Spojne style, podzial dlugich tresci.</li>
      <li>Kontrola cytowanych fragmentow; gotowe do publikacji.</li>
    </ul>
  </div>
  <div class="service-image">
